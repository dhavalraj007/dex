...
namespace core
{
	...
	void Window::create(const WindowProperties& props)
	{
        ...
        std::cout<<std::format("vendor:{} , \nRenderer:{},\nVersion:{} \nShading Language Version:{}",(const char*)glGetString(GL_VENDOR),(const char*)glGetString(GL_RENDERER),(const char*)glGetString(GL_VERSION),(const char*)glGetString(GL_SHADING_LANGUAGE_VERSION));
