...
Texture::Texture(const std::filesystem::path &path, int texUnit)
        : m_Id(0), m_TexUnit(texUnit) {
...
void Texture::LoadTexture(const unsigned char *data) {
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, specs.ChannelFormat, specs.Width, specs.Height, 0, specs.ChannelFormat, GL_UNSIGNED_BYTE,
