...
namespace mix_
{
    ...
    entry<glm::vec2, bool> const TestVec2Bool[] = {{glm::vec2(0.0f), glm::vec2(1.0f), false, glm::vec2(0.0f)},
    ...
    entry<glm::vec3, bool> const TestVec3Bool[] = {{glm::vec3(0.0f), glm::vec3(1.0f), false, glm::vec3(0.0f)},
    ...
    entry<glm::vec3, glm::bvec3> const TestBVec3[] = {
        ...
        {glm::vec3(1.0f, 2.0f, 3.0f), glm::vec3(4.0f, 5.0f, 6.0f), glm::bvec3(true, false, true),
         glm::vec3(4.0f, 2.0f, 6.0f)}};

    entry<glm::vec4, bool> const TestVec4Bool[] = {{glm::vec4(0.0f), glm::vec4(1.0f), false, glm::vec4(0.0f)},
    ...
    entry<glm::vec4, glm::bvec4> const TestBVec4[] = {
        {glm::vec4(0.0f, 0.0f, 1.0f, 1.0f), glm::vec4(2.0f, 2.0f, 3.0f, 3.0f), glm::bvec4(false, true, false, true),
        ...
        {glm::vec4(1.0f, 2.0f, 3.0f, 4.0f), glm::vec4(5.0f, 6.0f, 7.0f, 8.0f), glm::bvec4(true, false, true, false),
...
namespace round_
{
    static int test()
    {
...

        {
            ...
            float B = glm::round(-0.5f);
            Error +=
                (glm::equal(B, -1.0f, glm::epsilon<float>()) || glm::equal(B, 0.0f, glm::epsilon<float>())) ? 0 : 1;
            float C = glm::round(-1.0f);
            Error += glm::equal(C, -1.0f, glm::epsilon<float>()) ? 0 : 1;
            float D = glm::round(-0.1f);
            Error += glm::equal(D, 0.0f, glm::epsilon<float>()) ? 0 : 1;
...
#pragma warning(pop)
    ...
    int test_i32vec4()
    {
        type<glm::ivec4> const Data[] = {{glm::ivec4(1), glm::ivec4(1)},   {glm::ivec4(0), glm::ivec4(0)},
