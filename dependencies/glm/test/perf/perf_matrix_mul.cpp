...
template <typename matType>
static int launch_mat_mul_mat(std::vector<matType> &O, matType const &Transform, matType const &Scale,
                              std::size_t Samples)
{
...
static int comp_mat4_mul_mat4(std::size_t Samples)
{
    ...
    packedMatType const Scale(0.01, 0.02, 0.03, 0.05, 0.01, 0.02, 0.03, 0.05, 0.01, 0.02, 0.03, 0.05, 0.01, 0.02, 0.03,
                              0.05);
