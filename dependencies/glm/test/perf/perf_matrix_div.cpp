...
template <typename matType>
static int launch_mat_div_mat(std::vector<matType> &O, matType const &Transform, matType const &Scale,
                              std::size_t Samples)
{
...
static int comp_mat4_div_mat4(std::size_t Samples)
{
    ...
    packedMatType const Scale(0.01, 0.02, 0.05, 0.04, 0.02, 0.08, 0.05, 0.01, 0.08, 0.03, 0.05, 0.06, 0.02, 0.03, 0.07,
                              0.05);
