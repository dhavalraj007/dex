...
namespace glm
{
    ...
    /// Creates a matrix for a symmetric perspective-view frustum using left-handed coordinates if GLM_FORCE_LEFT_HANDED
    ...
    /// Creates a matrix for a symmetric perspective-view frustum based on the default handedness and default near and
    /// far clip planes definition. To change default handedness use GLM_FORCE_LEFT_HANDED. To change default near and
    /// far clip planes definition use GLM_FORCE_DEPTH_ZERO_TO_ONE.
    ///
