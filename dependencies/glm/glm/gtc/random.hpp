...
namespace glm
{
    ...
    /// Generate a random 2D vector which coordinates are regularly distributed within the area of a disk of a given
    /// radius
    ///
    /// @see gtc_random
    template <typename T>
    ...
    /// Generate a random 3D vector which coordinates are regularly distributed within the volume of a ball of a given
    /// radius
    ///
    /// @see gtc_random
    template <typename T>
